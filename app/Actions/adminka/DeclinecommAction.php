<?php
/**
* Действие БО отклонить оплату комиссии
*/
class DeclinecommAction extends AdminkaAction
{
	public function execute()
	{
        ...
        $commObj->status = SiteCommision::STATUS_NEW;
        $commObj->dateConfirm = null;
        $commObj->payAmount = 0;
        ...
        Adminka::redirectBack("Платеж отклонен, уведомление отправлено");
    }
    ...
    {
        $shortTitle = "Ваш платеж отклонен";
        ...
        $body = Utility::prepareStringForMail(MailTextHelper::parse("commdeclined.html", $vars));
